...
Delay_from_due_date = st.number_input('Delay_from_due_date', min_value=0, value=9)
...
Monthly_Balance = st.number_input('Monthly_Balance', min_value=-5000.0, format="%.2f", value=554.930282)
