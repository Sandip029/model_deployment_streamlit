...
Annual_Income = st.number_input('Annual_Income', min_value=1000, format="%.2f", value=43391.96)
Monthly_Inhand_Salary = st.number_input('Monthly_Inhand_Salary', min_value=100, format="%.2f", value=3688.99)
...
Changed_Credit_Limit = st.number_input('Changed_Credit_Limit', min_value=0, format="%.2f", value=10.72)
...
Outstanding_Debt = st.number_input('Outstanding_Debt', min_value=0, format="%.2f", value=1468.28)
Credit_Utilization_Ratio = st.number_input('Credit_Utilization_Ratio', min_value=20, format="%.2f", value=29.11)
...
Amount_invested_monthly = st.number_input('Amount_invested_monthly', min_value=0, format="%.2f", value=47.438673)
Payment_Behaviour = st.selectbox('Payment_Behaviour', ['Low', 'Medium', 'High'])
Monthly_Balance = st.number_input('Monthly_Balance', min_value=-5000, format="%.2f", value=554.930282)
